...
CREATE TABLE
    IF NOT EXISTS user_pass (
        ...
        CONSTRAINT fk_user_pass_createur_id FOREIGN KEY (createur_id) REFERENCES users (user_id) ON DELETE SET NULL,
        CONSTRAINT fk_user_pass_modifieur_id FOREIGN KEY (modifieur_id) REFERENCES users (user_id) ON DELETE SET NULL
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE
    IF NOT EXISTS user_profils (
        ...
        CONSTRAINT fk_user_profils_createur_id FOREIGN KEY (createur_id) REFERENCES users (user_id) ON DELETE SET NULL,
        CONSTRAINT fk_user_profils_modifieur_id FOREIGN KEY (modifieur_id) REFERENCES users (user_id) ON DELETE SET NULL,
