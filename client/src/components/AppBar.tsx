...
import { getMenuObjectListByPermissions } from "../utilities/linksAndPermissions.utilities";
...
const AppBar = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  const onLogout = async (e: React.MouseEvent) => {
    e.preventDefault();
    await userApi(updateSessionData).logoutUserApi();
  };
            ...
            {sessionData.currentUser && (
              <>
                ...
                >
                  ...
                  >
                    {`${sessionData.currentUser.nom} ${sessionData.currentUser.prenom}`.trim()}
                  </Typography>
                  <IconButton
                    size="large"
                    edge="end"
